...
default_cfg_file = "default_cfg_24.txt"
...
position_ip = 105
position_route = 303
position_location = 317
position_vlanif = 103
position_vlan_batch = 9
position_vlan_description = 67
position_uplink = 299
...
result_cfg = default_cfg[0:position_vlan_batch+1] + vlan_batch + \
             default_cfg[position_vlan_batch+2:position_vlan_description] + vlan_description +\
             default_cfg[position_vlan_description+1:position_uplink] + uplinks + \
