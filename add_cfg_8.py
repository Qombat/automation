...
default_cfg_file = "default_cfg_8.txt"
...
position_ip = 105
position_route = 191
position_location = 205
position_vlanif = 103
position_vlan_batch = 9
position_vlan_description = 66
position_uplink = 186
...
uplinks = list(changes[3])





result_cfg = default_cfg[0:position_vlan_batch+1] + vlan_batch + \
             default_cfg[position_vlan_batch+2:position_vlan_description+1] + vlan_description +\
             default_cfg[position_vlan_description+2:position_uplink+1] + uplinks + \
             default_cfg[position_uplink+3:len(default_cfg)]
